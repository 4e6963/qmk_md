...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                            KC_P1,   KC_P2,   KC_P3,            \
                                                                                                                             KC_UP,                                       KC_PENT, \
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_DEL,  MO(1),                                                KC_P0,   KC_PDOT,          \
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                            _______, _______, _______,          \
                                                                                                                             KC_PGUP,                                     _______, \
        _______, _______, _______,                   _______,                            KC_INSERT, _______,                                   _______, _______,                   \
...
bool processUmlaut(uint16_t keycode, keyrecord_t *record) {
  if (IS_LAYER_ON(2) && record->event.pressed) {
    if(keycode == KC_O) {
      if(is_shift_active){
...
bool checkUmlaut(uint16_t keycode, keyrecord_t *record){
    switch (keycode) {
        case KC_LSFT:
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case MD_BOOT:
            ...
            return false;
        default:
            return checkUmlaut(keycode, record);
    }
}
